...
subplot 222;plot(i,a1,'r',i,a2,'g:',i,b1,'b',i,b2,'m:','linewidth',2);xlabel('t');ylabel('辨识参数');
% title('Parameter Identification with Recursive Least Squares Method')% 图形标题
k=j-2;
text(k-4,-1.5+0.2,['a1=-1.5,| ',num2str(a1(end))]);
text(k-4,0.7+0.2,['a2=0.7,| ',num2str(a2(end))]);
text(k-4,1+0.2,['b1=1,| ',num2str(b1(end))]);
text(k-4,0.5-0.2,['b2=0.5,| ',num2str(b2(end))]);
subplot 224;plot(i,ea1,'r',i,ea2,'g:',i,eb1,'b',i,eb2,'m:','linewidth',2); % 画出a1，a2，b1，b2的各次辨识结果的收敛情况
xlabel('t');ylabel('e'); legend('a1','a2','b1','b2');
